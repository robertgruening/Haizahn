...
--
ALTER TABLE `Tag`
  ADD CONSTRAINT `Tag_ibfk_1` FOREIGN KEY (`User_Id`) REFERENCES `User` (`Id`);

--
-- Constraints for table `User`
--
ALTER TABLE `User`
  ADD CONSTRAINT `User_Bookmark` FOREIGN KEY (`Id`) REFERENCES `Bookmark` (`User_Id`) ON DELETE CASCADE ON UPDATE NO ACTION;
